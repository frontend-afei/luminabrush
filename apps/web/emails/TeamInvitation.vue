<template>
	<Wrapper>
		...
		<EText>
			You have been invited to join the team {{ teamName }}. Click the button below or copy and paste the link into your
			browser of choice to accept the invitation and join the team.
		</EText>

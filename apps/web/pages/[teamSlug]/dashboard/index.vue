<template>
	<div class="container max-w-6xl py-8">
		<SaasPageHeader>
			<template #title>{{ t('dashboard.welcome', { name: user?.name }) }}</template>
		...
		<Card class="mt-8">
			<div class="text-muted-foreground flex h-64 items-center justify-center p-8">Place your content here...</div>
		</Card>
	</div>
</template>

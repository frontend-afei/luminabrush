		...
		<DropdownMenuTrigger
			...
			<div class="flex items-center justify-start gap-2 text-sm">
				<span class="hidden lg:block">
					<TeamAvatar class="size-8" :name="currentTeam.name" :avatar-url="currentTeam.avatarUrl" />
				</span>
			...
			<DropdownMenuRadioGroup v-model="activeTeamIdModel">
				<DropdownMenuRadioItem
					...
					<div class="flex flex-1 items-center justify-start gap-2">
						<TeamAvatar class="size-6" :name="teamMembership.team.name" :avatar-url="teamMembership.team.avatarUrl" />
